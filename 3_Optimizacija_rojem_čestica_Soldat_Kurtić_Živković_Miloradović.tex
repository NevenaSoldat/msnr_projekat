...
\author{Nevena Soldat, Milena Kurtić,Tijana Živković , Ana Miloradović \\
...
Neka je \[x_i(t)\] pozicija čestice i u prostoru pretrage u trenutku t. Pozicija čestice se menja dodavanjem brzine, \[v_i(t)\] na trenutnu poziciju. \[x_i(t+1) = x_i(t) + v_i(t+1) \]
