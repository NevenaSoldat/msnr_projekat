...
U ovom radu predstavljeni su osnovni koncepti optimizacione tehnike zasnovane na roju cestica. Opisani su glavni algoritmi, značaj i varijacije parametara, primene ove tehnike kao i različite populacione strukture čijim menjanjem, kao i menjanjem parametara, možemo da podešavamo i prilagođavamo ovu populacionu tehniku različitim problemima. 
}
